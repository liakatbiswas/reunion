                    ...
                    <div class="flex flex-col md:flex-row h-screen">
                        ...
                        <div class="flex-[2] bg-gray-300">
                            <div class="flex flex-col items-center p-2 bg-orange-200">
                                ...
                                <img width="150px" src="{{ asset('liakat.jpg ') }}" alt="Liakat Biswas">
                                <div class="p-4">
                                    <h2 class="text-center text-2xl font-bold mb-2">Liakat Biswas</h2>
                            ...
                            <div class="flex flex-col items-center  bg-red-200 p-2">
                                <h2 class="text-3xl font-black text-center mb-4 text-blue-600"> Platinum Sponsor </h2>
                                <img width="150px" src="{{ asset('liakat.jpg ') }}" alt="Liakat Biswas">
                                <div class="p-4">
                                    <h2 class="text-center text-2xl font-bold mb-2">Liakat Biswas</h2>
                                    <p class="text-justify">
                        ...
                        <div class="flex-[2] bg-gray-300">
                            ...
                            <div class="flex flex-col items-center p-2 bg-red-200 p-2">
                                <h2 class="text-3xl font-black text-center mb-4 text-blue-600"> Gold Sponsor </h2>
                                <img width="150px" src="{{ asset('liakat.jpg ') }}" alt="Liakat Biswas">
                                <div class="p-4">
                                    <h2 class="text-center text-2xl font-bold mb-2">Liakat Biswas</h2>
                                    <p class="text-justify">

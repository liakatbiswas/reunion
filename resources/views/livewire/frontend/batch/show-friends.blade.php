<div>
    @if (!$batch)
        <p class="text-red-600 font-bold text-4xl text-center">Batch not found.</p>
    @else
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                            @foreach ($friends as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-800">
                                    ...
                                    <td class="px-6 py-4 text-gray-800 dark:text-gray-200">{{ $item->division->name }}
                                    </td>
                                    <td class="px-6 py-4 text-gray-800 dark:text-gray-200">{{ $item->district->name }}
                                    </td>
                                    <td class="px-6 py-4 text-gray-800 dark:text-gray-200">{{ $item->upazila->name }}
                                    </td>
